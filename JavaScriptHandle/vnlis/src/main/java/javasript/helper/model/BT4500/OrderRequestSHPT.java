...
public class OrderRequestSHPT
{
    ...
    private List<String> dsBarcode;
    
    public OrderRequestSHPT() {
    }
    
    public OrderRequestSHPT(final int maDonVi, final int maMay, final boolean ordered, final List<OrderMaXN_ChiTiet> maXNs, final List<String> dsBarcode) {
    ...
    public List<String> getDsBarcode() {
        return this.dsBarcode;
    }
    
    public void setDsBarcode(final List<String> dsBarcode) {
        this.dsBarcode = dsBarcode;
    }
}
